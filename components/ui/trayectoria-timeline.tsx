...
/* -------------------------------------------------------------------------
   Carrusel con "pista" de marcas abajo (patrón "revision timeline" de
   Great UI, great-ui.com), reescrito para la paleta de este sitio.
   `periodo` y `anio` son opcionales: hay hitos sin fecha puntual (áreas de
   trabajo generales, no un puesto con institución y año concretos).
------------------------------------------------------------------------- */
        ...
        <div className="flex flex-col justify-center p-7 sm:p-9">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {hito.lugar ? (
                <p className="mt-1.5 text-[15px] font-semibold text-ink/70">{hito.lugar}</p>
              ) : null}
            ...
            {marcas.map((m, idx) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  disabled={!esHito}
                  aria-label={esHito ? `Ir a ${hitos[m.indiceHito].rol}` : undefined}
